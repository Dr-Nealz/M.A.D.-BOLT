...
export const URL_CONFIGURABLE_PROVIDERS = ['Ollama', 'LMStudio', 'OpenAILike', 'NVIDIA', '9router'];
export const LOCAL_PROVIDERS = ['OpenAILike', 'LMStudio', 'Ollama', 'NVIDIA', '9router'];
