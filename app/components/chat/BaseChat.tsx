              ...
              <div id="intro" className="mt-[16vh] max-w-2xl mx-auto text-center px-4 lg:px-0">
                <div className="relative mb-4">
                  <div
                    ...
                    style={{
                      background:
                        'linear-gradient(120deg, rgba(107,140,255,0.55), rgba(45,212,191,0.45), rgba(236,72,153,0.45))',
                    }}
                  />
                  <h1 className="relative text-3xl lg:text-6xl font-bold animate-fade-in">
                    <span className="text-aurora bg-[linear-gradient(120deg,#6B8CFF,#2DD4BF,#EC4899)] bg-clip-text text-transparent drop-shadow-[0_0_24px_rgba(107,140,255,0.45)]">
                      M.A.D. BOLT-REMIX
                    </span>
                  </h1>
                </div>
