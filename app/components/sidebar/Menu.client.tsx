    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-white/80 dark:bg-bolt-elements-background-depth-2/80 backdrop-blur-xl border-r border-bolt-elements-borderColor',
          'shadow-sm text-sm',
      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/50 rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            <HelpButton onClick={() => window.open('https://github.com/Dr-Nealz/M.A.D.-BOLT', '_blank')} />
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-bolt-elements-background-depth-3/70 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-accent-500/50 text-sm text-gray-900 dark:text-bolt-elements-textPrimary placeholder-gray-500 dark:placeholder-bolt-elements-textTertiary border border-gray-200 dark:border-bolt-elements-borderColor"
                type="search"
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-2 first:mt-0 space-y-1">
                  <div className="text-xs font-medium text-gray-500 dark:text-bolt-elements-textTertiary sticky top-0 z-1 bg-white dark:bg-bolt-elements-background-depth-2/90 px-4 py-1">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-white dark:bg-bolt-elements-background-depth-2">
                      <DialogTitle className="text-gray-900 dark:text-bolt-elements-textPrimary">
                        Delete Chat?
                      </DialogTitle>
