    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from M.A.D. BOLT-REMIX' : 'Update from M.A.D. BOLT-REMIX',
          tree: treeData.sha,
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <motion.a
                      ...
                      className="px-4 py-2 rounded-lg bg-aurora text-white hover:opacity-90 text-sm inline-flex items-center gap-2"
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <div className="pt-2 flex justify-center gap-3">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-aurora text-white text-sm hover:opacity-90 inline-flex items-center gap-2"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:github-logo w-4 h-4" />
                  ...
                  <div className="pt-4 flex gap-2">
                    ...
                    <motion.button
                      ...
                      className={classNames(
                        'flex-1 px-4 py-2 bg-aurora text-white rounded-lg hover:opacity-90 text-sm inline-flex items-center justify-center gap-2',
