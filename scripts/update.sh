...
echo "Starting M.A.D. BOLT-REMIX update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/Dr-Nealz/M.A.D.-BOLT/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
