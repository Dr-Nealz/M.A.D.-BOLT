...
const BASE_COLORS = {
  ...
  // Multiverse Aurora accent — violet → indigo (primary brand, drives accent-* tokens)
  accent: {
    50: '#F5F7FF',
    100: '#EBF0FF',
    200: '#D6E2FF',
  ...
  // GALVANI by M.A.D. LABS — signature brand tokens (Blend mode)
  spark: {
    DEFAULT: '#2CE5B8',
    50: '#E9FCF7',
    100: '#C8F8EC',
...
const COLOR_PRIMITIVES = {
  ...
  alpha: {
    ...
    teal: generateAlphaPalette(BASE_COLORS.teal[400]),
    pink: generateAlphaPalette(BASE_COLORS.pink[500]),
    spark: generateAlphaPalette(BASE_COLORS.spark[400]),
...
export default defineConfig({
  ...
  shortcuts: {
    ...
    // Multiverse Aurora signature gradient utilities
    'bg-aurora': 'bg-[linear-gradient(120deg,#6B8CFF,#2DD4BF,#EC4899)]',
    'text-aurora': 'bg-[linear-gradient(120deg,#6B8CFF,#2DD4BF,#EC4899)] bg-clip-text text-transparent',
    'border-aurora': 'border-[linear-gradient(120deg,#6B8CFF,#2DD4BF,#EC4899)]',
    // GALVANI by M.A.D. LABS signature gradient utilities (Blend mode)
    'bg-galvani': 'bg-[linear-gradient(120deg,#2CE5B8,#7C5CFF)]',
    'text-galvani': 'bg-[linear-gradient(120deg,#2CE5B8,#7C5CFF)] bg-clip-text text-transparent',
    'border-galvani': 'border-[linear-gradient(120deg,#2CE5B8,#7C5CFF)]',
  },
  rules: [
    /**
...
function generateAlphaPalette(hex: string) {
  return [1, 2, 3, 4, 5, 10, 15, 20, 25, 30, 40, 50, 60, 70, 80, 90, 100].reduce(
    (acc, opacity) => {
